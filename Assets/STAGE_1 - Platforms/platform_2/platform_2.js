...
private var correct_distance : int = 797;
...
function execute_code() 
{
	...
	move_distance = E1_scope.GetVariable.<int>("move_distance");
	Debug.Log(move_distance);
	Debug.Log(correct_distance);

	if (move_distance == correct_distance) 
	{
		// reassign editable variables
		power_on = E1_scope.GetVariable.<boolean>("power_on");
		velocity = E1_scope.GetVariable.<int>("velocity");
		move_direction = E1_scope.GetVariable.<int>("move_direction");
